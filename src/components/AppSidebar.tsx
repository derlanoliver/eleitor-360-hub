    ...
    const content = (
      <SidebarMenuButton asChild>
        <NavLink 
          ...
          className={({ isActive }) => `
            ${getNavCls(isActive)} 
            flex items-center ${isCollapsed ? 'justify-center' : 'px-3'} py-2 rounded-lg text-sm font-medium transition-colors w-full
          `}
        >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <SidebarMenuButton asChild>
                  <NavLink 
                    to="/login" 
                    className="text-red-600 hover:bg-red-50 w-full flex items-center justify-center py-2 rounded-lg text-sm font-medium transition-colors"
                  >
