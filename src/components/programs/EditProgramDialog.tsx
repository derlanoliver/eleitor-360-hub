...
import { Program } from "@/hooks/programs/usePrograms";
...
const formSchema = z.object({
  ...
  impacto: z.coerce.number().min(0, "Impacto deve ser positivo"),
});
...
export const EditProgramDialog = ({ program, children }: EditProgramDialogProps) => {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      inicio: parseISO(program.inicio),
      impacto: program.impacto,
    },
  });
    ...
    updateProgram(
      {
        ...
        status: data.status,
        inicio: format(data.inicio, "yyyy-MM-dd"),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ex: Saúde em Ação" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
