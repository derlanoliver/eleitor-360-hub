-- Recriar função sync_event_registration_contact com source_type correto
...
BEGIN
  ...
  IF existing_contact_id IS NOT NULL THEN
    -- Update existing contact with new data if current is empty
  ...
  ELSE
    -- Create new contact with correct source_type
    ...
    VALUES (
      ...
      'evento',  -- Valor correto (era 'event_registration')
      NEW.id,
