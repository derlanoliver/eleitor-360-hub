-- Atualizar função para incluir TODOS os líderes com subordinados não verificados (não apenas coordenadores)
...
AS $$
  WITH RECURSIVE leader_tree AS (
    -- Começar com TODOS os líderes ativos (não apenas coordenadores)
