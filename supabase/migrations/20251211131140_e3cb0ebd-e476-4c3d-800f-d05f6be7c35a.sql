-- Fix source_id type mismatch in upsert_contact_from_leader_form function
-- source_id column is UUID, not TEXT
...
BEGIN
  ...
  SELECT office_contacts.id, office_contacts.source_type, office_contacts.source_id, office_contacts.is_verified
