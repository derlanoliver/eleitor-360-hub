-- Address linter warning: ensure SECURITY DEFINER function has an explicit, immutable search_path.

CREATE OR REPLACE FUNCTION public.get_leaders_by_birthday(
  p_cidade_id uuid DEFAULT NULL::uuid,
  p_search text DEFAULT NULL::text,
  p_verification_filter text DEFAULT 'all'::text,
