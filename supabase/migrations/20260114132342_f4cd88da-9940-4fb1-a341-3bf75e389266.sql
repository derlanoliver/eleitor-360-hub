-- Remover overloads conflitantes e manter apenas UMA assinatura (com data_nascimento como date)
DROP FUNCTION IF EXISTS public.public_create_leader_self_registration(text,text,text,uuid,date,text);
