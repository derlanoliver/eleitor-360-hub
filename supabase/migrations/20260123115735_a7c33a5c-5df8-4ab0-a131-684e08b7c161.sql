-- Corrigir função sync_event_registration_contact usando telefone_norm ao invés de telefone
...
BEGIN
  ...
  -- Check if contact already exists by phone (using telefone_norm column)
  ...
  ELSE
    -- Create new contact (using telefone_norm column)
